...
@section('utama')
            ...
            <div class="row">
                ...
                <table class = "table table-hover">
                    ...
                    <?php $no=0;?>       <!--deklarasi untuk nomor-->
                    @foreach($data_siswa as $siswa) <!-- looping untuk memanggil database siswa-->
                    <?php $no++;?>
                    <tr>
                        <td>{{$no}}</td>
                        ...
                        <td>{{$siswa->alamat}}</td>
                        <td>
                            <a href="/siswa/{{$siswa->id}}/edit" class="btn btn-warning btn-sm">edit</a>  <!--untuk tombol edit-->
